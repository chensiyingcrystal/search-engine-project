...
public interface AppendEntriesRequestProtoOrBuilder extends
   ...
   */
  java.util.List<cluster.proto.LogEntryProto> 
      getEntryList();
  /**
   * <code>repeated .proto.LogEntryProto entry = 7;</code>
   */
  cluster.proto.LogEntryProto getEntry(int index);
  /**
   * <code>repeated .proto.LogEntryProto entry = 7;</code>
   */
  int getEntryCount();
   ...
   * <code>repeated .proto.LogEntryProto entry = 7;</code>
   */
  java.util.List<? extends cluster.proto.LogEntryProtoOrBuilder> 
      getEntryOrBuilderList();
  /**
   * <code>repeated .proto.LogEntryProto entry = 7;</code>
   */
  cluster.proto.LogEntryProtoOrBuilder getEntryOrBuilder(
      int index);
