...
public final class ClusterListenServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<cluster.external.listener.proto.ClusterEndpointsRequest,
      cluster.external.listener.proto.ClusterEndpointsResponse> getListenClusterEndpointsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "listenClusterEndpoints",
      requestType = cluster.external.listener.proto.ClusterEndpointsRequest.class,
      responseType = cluster.external.listener.proto.ClusterEndpointsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<cluster.external.listener.proto.ClusterEndpointsRequest,
      cluster.external.listener.proto.ClusterEndpointsResponse> getListenClusterEndpointsMethod() {
    io.grpc.MethodDescriptor<cluster.external.listener.proto.ClusterEndpointsRequest, cluster.external.listener.proto.ClusterEndpointsResponse> getListenClusterEndpointsMethod;
      ...
      synchronized (ClusterListenServiceGrpc.class) {
        if ((getListenClusterEndpointsMethod = ClusterListenServiceGrpc.getListenClusterEndpointsMethod) == null) {
          ClusterListenServiceGrpc.getListenClusterEndpointsMethod = getListenClusterEndpointsMethod =
              io.grpc.MethodDescriptor.<cluster.external.listener.proto.ClusterEndpointsRequest, cluster.external.listener.proto.ClusterEndpointsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "listenClusterEndpoints"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cluster.external.listener.proto.ClusterEndpointsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cluster.external.listener.proto.ClusterEndpointsResponse.getDefaultInstance()))
  ...
  public static abstract class ClusterListenServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void listenClusterEndpoints(cluster.external.listener.proto.ClusterEndpointsRequest request,
        io.grpc.stub.StreamObserver<cluster.external.listener.proto.ClusterEndpointsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                cluster.external.listener.proto.ClusterEndpointsRequest,
                cluster.external.listener.proto.ClusterEndpointsResponse>(
  ...
  public static final class ClusterListenServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ClusterListenServiceBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<cluster.external.listener.proto.ClusterEndpointsResponse> listenClusterEndpoints(
        cluster.external.listener.proto.ClusterEndpointsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LISTEN_CLUSTER_ENDPOINTS:
          serviceImpl.listenClusterEndpoints((cluster.external.listener.proto.ClusterEndpointsRequest) request,
              (io.grpc.stub.StreamObserver<cluster.external.listener.proto.ClusterEndpointsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ClusterListenServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cluster.external.listener.proto.ClusterListener.getDescriptor();
    }
