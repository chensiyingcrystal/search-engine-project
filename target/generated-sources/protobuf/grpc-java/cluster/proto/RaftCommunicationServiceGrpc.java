...
public final class RaftCommunicationServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<cluster.proto.RaftMessageRequest,
      cluster.proto.RaftMessageResponse> getHandleRaftMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "handleRaftMessage",
      requestType = cluster.proto.RaftMessageRequest.class,
      responseType = cluster.proto.RaftMessageResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<cluster.proto.RaftMessageRequest,
      cluster.proto.RaftMessageResponse> getHandleRaftMessageMethod() {
    io.grpc.MethodDescriptor<cluster.proto.RaftMessageRequest, cluster.proto.RaftMessageResponse> getHandleRaftMessageMethod;
      ...
      synchronized (RaftCommunicationServiceGrpc.class) {
        if ((getHandleRaftMessageMethod = RaftCommunicationServiceGrpc.getHandleRaftMessageMethod) == null) {
          RaftCommunicationServiceGrpc.getHandleRaftMessageMethod = getHandleRaftMessageMethod =
              io.grpc.MethodDescriptor.<cluster.proto.RaftMessageRequest, cluster.proto.RaftMessageResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "handleRaftMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cluster.proto.RaftMessageRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cluster.proto.RaftMessageResponse.getDefaultInstance()))
  ...
  public static abstract class RaftCommunicationServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<cluster.proto.RaftMessageRequest> handleRaftMessage(
        io.grpc.stub.StreamObserver<cluster.proto.RaftMessageResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncClientStreamingCall(
              new MethodHandlers<
                cluster.proto.RaftMessageRequest,
                cluster.proto.RaftMessageResponse>(
  ...
  private static abstract class RaftCommunicationServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cluster.proto.RaftRpc.getDescriptor();
    }
